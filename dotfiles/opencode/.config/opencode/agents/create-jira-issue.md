...
Ask the user to describe what they want the ticket to be about if they haven't already.
...
Draft a Jira ticket based on the information provided by the user. The ticket should include the following sections:
